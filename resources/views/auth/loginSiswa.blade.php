...
<div class="bg-white p-10 rounded-lg shadow-lg text-center w-full max-w-md">
    <h3 class="text-2xl font-semibold mb-4">Login Siswa</h3>
    ...
    <p class="mt-4 text-sm"><a href="{{ route('forgotPasswordSiswa') }}"class="text-blue-500 hover:underline">Forgot password?</a></p>
</div>
